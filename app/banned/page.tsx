...
export default function BannedComponent({
  ...
  const onSubmit: SubmitHandler<ContactFormData> = async (formData) => {
    ...
    try {
      ...
      // toast.success("Email sent successfully"); // (Make sure toast is imported)
    } catch (error: any) {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      >
        ...
        {/* Contact Support */}
        <p className="text-xs text-gray-500 mt-6 flex flex-col md:flex-row justify-center items-start mx-auto">
          <span>If you believe this is a mistake, please</span>
          {bannedUntil && (
            <span
              className="flex items-center cursor-pointer md:text-gray-500 text-blue-500 hover:text-blue-600 md:ml-1"
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b-2 border-gray-300 focus:border-blue-500 focus:outline-none py-2"
                />
                {errors.user_name && (
                ...
                <input
                  ...
                  {...register("user_email")}
                  className="w-full outline-0 bg-gray-100 cursor-not-allowed border-b-2 border-gray-300 text-gray-500 py-2"
                />
                ...
                <textarea
                  ...
                  className="w-full bg-transparent border-b-2 border-gray-300 focus:border-blue-500 focus:outline-none py-2 resize-none"
                />
                {errors.message && (
                ...
                <button
                  ...
                  className="mt-2 flex group cursor-pointer text-gray-500 hover:text-blue-500 items-center gap-1.5 w-fit mx-auto py-1 px-4 font-semibold border-b-2 border-b-gray-500 hover:border-b-blue-500 disabled:opacity-50"
                >
                  {sending ? "Sending..." : "Send Email"}
                  <Send size={17} className="group-hover:text-blue-500" />
                </button>
              </form>
            </motion.div>
          )}
